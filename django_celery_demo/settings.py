...
SECRET_KEY = 'm7txb(4*!cs##_jw4my5w-_8-mc1aoabzfcp$r&@ki2s@=y9w4'
...
redis_locate = 'redis://127.0.0.1:6379/0' 

# ------------------------------------------------------------------------
CELERY_BROKER_URL = redis_locate
# http://docs.celeryproject.org/en/latest/userguide/configuration.html#std:setting-result_backend
CELERY_RESULT_BACKEND = redis_locate
